...
Open Payments requiere que el remitente dé su consentimiento explícito para la creación del recurso antes de que el cliente pueda emitir la solicitud de creación. El consentimiento se obtiene mediante una concesión interactiva [interactive grant](/concepts/auth/#outgoing-payment).
...
Para obtener más información sobre el servidor de autorización y los tipos de subvención, consulte [Tipos de subvención](/concepts/auth/#grant-types).
